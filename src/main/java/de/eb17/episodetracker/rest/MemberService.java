...
/**
 * This class produces a RESTful service to handle requests for the contents of the members table.
 */
@Path("/members")
@RequestScoped
...
public class MemberService {
    ...
    /**
     * Simple authentication for a registered member by email and password
     * 
     * @return The stored member and his data
     */
    @GET
    @Path("/signin")
